...
public class AccountController {
	...
	public Account createAccount(@PathVariable(value = "bankId") Long bankId, @Valid @RequestBody Account account) {
	...
	public Account updateAccount(@PathVariable(value = "bankId") Long bankId,
	...
	public ResponseEntity<?> deleteAccount(@PathVariable(value = "bankId") Long bankId,
